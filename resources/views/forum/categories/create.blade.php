    ...
    <form method="POST" action="/forum/category/store" enctype="multipart/form-data">
      ...
      <div class="mb-6">
        <label for="hideCategoryFrom" class="inline-block text-lg mb-2">
          Hide this category from
        </label>
        <select data-live-search="true" multiple="multiple" class="js-select2 form-control border border-gray-200 rounded p-2 w-full" name="hideCategoryFrom[]" id="hideCategoryFrom" size="{{count($users)}}" >
